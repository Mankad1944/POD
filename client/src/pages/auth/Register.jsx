...
const Register = () => {
  return (
    <div className="w-full h-screen p-0 flex relative bg-amber-500">
        ...
        <div className="md:w-1/2 max-lg:landscape:w-full w-full justify-items-center content-center max-lg:landscape:h-auto h-screen bg-amber-100 absolute right-0 md:rounded-l-3xl max-lg:landscape:rounded-none">
            {/* <div className="relative bg-amber-700 top-0">sv</div> */}
            <a href="/" className="material-symbols-outlined absolute border-2 border-amber-600 top-10 left-10 rounded-full p-3 text-amber-600 hover:text-white hover:bg-amber-600 transition-all duration-300">arrow_back</a>
            <div className="font-extrabold text-4xl text-amber-600 mb-5 max-lg:landscape:mt-10">Register</div>
            <div className="h-120 p-10 w-90 md:w-110 border-2 border-amber-900 rounded-3xl max-lg:landscape:mb-10 overflow-scroll">
                <form action="" className="">
                    <label htmlFor="name">Name</label>
                    <input type="text" name="name" placeholder="Name" className="mb-5 p-2 border-2 border-amber-900 rounded-xl w-full" />
                    
                    <label htmlFor="no">Mobile no.</label>
                    <input type="number" name="no" placeholder="99999xxxxx" className="mb-5 p-2 border-2 border-amber-900 rounded-xl w-full" />
