...
const Container1 = () => {
  return (
    <div className="md:flex text-amber-600 p-8 w-full min-h-screen bg-amber-50 items-center">
        <div className="md:w-1/2 w-full mr-5 md:mb-10 md:h-100 h-120 md:mt-20 mt-20 flex flex-wrap">
            ...
            <div className="flex flex-col md:flex-row items-center gap-3 w-full md:w-auto">
                <a href="/" className="hover:scale-90 duration-300 rounded-full px-5 py-3 w-full md:text-base max-lg:landscape:text-xs md:w-auto bg-amber-800 text-amber-200">
